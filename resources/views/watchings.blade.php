            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="anime__video__player">
                        <div class="anime__video__player">
                        <h1 style="font-weight: bold; color: white;">JUJUTSU KAISEN 2</h1>
                        <br>
                        <video id="player" playsinline controls data-poster="./videos/1185026.jpg">
                            <source src="videos/jujurkaisen.mp4" type="video/mp4" />
